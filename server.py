...
server_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM) #SOCK_STREAM is a tcp connection
...
while True:
    communication_socket, address = server_socket.accept()     #server.accept() returns address of connecting client and socket we can use to talk to the client
